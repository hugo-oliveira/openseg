...
exp_name = conv_name + '_' + dataset_name + '_openpca_dsm_' + args['hidden_classes']

pretrained_path = os.path.join(ckpt_path, exp_name.replace('openpca_dsm', 'base_dsm'), 'model_' + str(epoch) + '.pth')
