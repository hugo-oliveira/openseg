...
exp_name = conv_name + '_' + dataset_name + '_openmax_dsm_' + args['hidden_classes']

pretrained_path = os.path.join(ckpt_path, exp_name.replace('openmax_dsm', 'base_dsm'), 'model_' + str(epoch) + '.pth')
